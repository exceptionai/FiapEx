                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Padding(
                        padding:
                            const EdgeInsets.fromLTRB(20.0, 50.0, 20.0, 0.0),
                        child: loadingDropDown ? Center(child: CircularProgressIndicator(valueColor: AlwaysStoppedAnimation(Theme.of(context).primaryColor),),)
                        : DropdownButtonFormField<DisciplineModel>(
                          style: TextStyle(color: Colors.white),
                          decoration: InputDecoration(
                            enabledBorder: UnderlineInputBorder(
                                borderSide: BorderSide(color: disciplines.isEmpty ? Colors.grey[800] : Colors.white)),
                          ),
                          iconEnabledColor: Colors.white,
                          iconDisabledColor: Colors.grey[800],
                          hint: Text("Selecione a matéria", style: TextStyle(color: disciplines.isEmpty ? Colors.grey[800] : Colors.white),),
                          items: disciplines
                              .map((label) => DropdownMenuItem(
                                    child: Text(label.name),
                                    value: label,
                          ...
                          onSaved: (value) {},
                          onChanged: disciplines == null ? null : (value) {
